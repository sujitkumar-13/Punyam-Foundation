...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 w-full z-50 bg-background/95 backdrop-blur-sm border-b border-border shadow-sm">
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t border-border animate-fade-in">
              <nav className="flex flex-col gap-4">
                ...
                <Button
                  variant="default"
                  className="gradient-cta mt-2 w-full"
                  onClick={() => {
                    setIsMenuOpen(false);
